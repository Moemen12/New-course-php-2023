...
//Answer of the seventy assignment elzero web school

$nums = [1, 2, 3, 4, 5, 6];
$newArray=[];


while (count($newArray)!=count($nums) ) {
  $i=rand(1,6);            
  if(!(in_array($i,$newArray))){
...
//Answer of the eighty assignment elzero web school
...
echo(str_replace($find,$replace,$title,$replacement));
echo'<br>';
echo $replacement;
